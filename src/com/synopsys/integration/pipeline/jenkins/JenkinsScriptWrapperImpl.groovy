...
class JenkinsScriptWrapperImpl implements JenkinsScriptWrapper {
    ...
    void executeCommandWithHttpStatusCheck(String command, String expectedHttpStatusCode, String jsonResponseFileName, String githubCredentialsId, PipelineConfiguration pipelineConfiguration) {
        ...
        script.withCredentials([script.usernamePassword(credentialsId: githubCredentialsId, usernameVariable: 'GIT_USERNAME', tokenVariable: 'GIT_TOKEN')]) {
            String gitPassword = pipelineConfiguration.getScriptWrapper().getJenkinsProperty('GIT_TOKEN')
