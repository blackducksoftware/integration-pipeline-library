package com.blackduck.integration.pipeline.email

import com.blackduck.integration.pipeline.jenkins.BuildWrapper
...
class EmailPipelineWrapper extends PipelineWrapper {
    ...
    void end() {
        ...
        if (currentBuild.getResult() == "FAILURE") {
            ...
            String previousResult = previousBuild.getResult()
