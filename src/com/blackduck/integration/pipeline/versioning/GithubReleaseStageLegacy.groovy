...
class GithubReleaseStageLegacy extends Stage {
    ...
    GithubReleaseStageLegacy(PipelineConfiguration pipelineConfiguration, String stageName, boolean runRelease, String branch) {
    ...
    GithubReleaseStageLegacy(PipelineConfiguration pipelineConfiguration, String stageName, boolean runRelease, String artifactFile,
                             String branch) {
        super(pipelineConfiguration, stageName)
        this.runRelease = runRelease
    ...
    GithubReleaseStageLegacy(PipelineConfiguration pipelineConfiguration, String stageName, boolean runRelease, String artifactPattern,
